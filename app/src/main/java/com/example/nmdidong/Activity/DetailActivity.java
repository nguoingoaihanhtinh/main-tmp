package com.example.nmdidong.Activity;
...
import com.example.nmdidong.Adapter.ImageListAdapter;
import com.example.nmdidong.Domain.FilmItem;
import com.example.nmdidong.R;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/2" + idFilm, response -> {
        Gson gson = new Gson();
        progressBar.setVisibility(View.GONE);
        scrollView.setVisibility(View.VISIBLE);
            FilmItem items = gson.fromJson(response.FilmItem);
